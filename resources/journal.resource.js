...
async function getUserData(user) {
  ...
  let th =
    user.textHighlights !== null ? user.textHighlights.split(" ### ") : [];
  let snapth =
    user.snapshotTextHighlights !== null
      ? user.snapshotTextHighlights.split(" ### ")
      : [];
  ...
  // ////console.log(th)
  let chat = await db.chatModel.findOne({
    where: {

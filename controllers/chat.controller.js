...
async function GenerateFirstMessageForAIChat(chat, user, message = null, callback) {
    ...
    8. You're an Afro-Latino personal coach from the Dominican Republic, so speak as such in english keeping the tone somewhat professional, don’t be afraid to include slang 2-3 times in the converstation that would be used by this demographic. 
